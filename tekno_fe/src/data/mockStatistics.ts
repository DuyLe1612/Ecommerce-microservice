...
export const MOCK_STATISTICS = {
  overview: {
    ...
    completedOrders: 68,
    cancelledOrders: 6,
    orderCompletionRate: 47.9,
    orderCancellationRate: 4.2,
  },
  topProducts: [
  ...
  revenueByCategory: [
    { categoryId: 1, categoryName: "Điện thoại", totalRevenue: 450000000, percentage: 32.5 },
    ...
    { categoryId: 4, categoryName: "Phụ kiện", totalRevenue: 150000000, percentage: 10.8 },
    { categoryId: 5, categoryName: "Đồng hồ thông minh", totalRevenue: 87000000, percentage: 6.3 },
  ],
  topCustomers: [
    { id: 1, name: "Nguyễn Văn Minh", email: "minh.nguyen@email.com", totalOrders: 15, totalSpent: 45000000 },
    { id: 2, name: "Trần Thị Lan", email: "lan.tran@email.com", totalOrders: 12, totalSpent: 38000000 },
    { id: 3, name: "Lê Hoàng Nam", email: "nam.le@email.com", totalOrders: 10, totalSpent: 32000000 },
    { id: 4, name: "Phạm Thu Hà", email: "ha.pham@email.com", totalOrders: 8, totalSpent: 28000000 },
    { id: 5, name: "Đặng Quốc Bảo", email: "bao.dang@email.com", totalOrders: 7, totalSpent: 25000000 },
  ],
  revenueChart: [
  ...
  productPerformance: {
    ...
    lowStock: 35,
    lowStockAlerts: [
      { productId: 101, productName: "iPhone 14 Pro - Đen", stockLevel: 3 },
